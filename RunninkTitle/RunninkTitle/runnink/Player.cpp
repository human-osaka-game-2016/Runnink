...
void PlayerDraw()
{
	...
	{
		{ -900.f, 0.f, 1.f, 1.0f, 0xFFFFFFFF, 0.f, 0.f },
		{ 1000.f, 0.f, 1.f, 1.0f, 0xFFFFFFFF, 1.f, 0.f },
		{ 1000.f, 1020.f, 1.f, 1.0f, 0xFFFFFFFF, 1.f, 1.f },
		{ -900.f, 1020.f, 1.f, 1.0f, 0xFFFFFFFF, 0.f, 1.f }
	};
	...
	case GameOverScene:
		...
		{
		SetGameScene(g_pGameTexture[PLAYER_DEATH_TEX], PlayerDeath);//
		}
