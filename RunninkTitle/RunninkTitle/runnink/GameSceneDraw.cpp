...
void TextDraw()//追加点
{
	...
	CUSTOMVERTEX GameOverText[4]
	{
		...
		{ 1280.f, 0.f, 1.f, 1.0f, 0xFFFFFFFF, 1.f, 0.f },
		{ 1280.f, 350.f, 1.f, 1.0f, 0xFFFFFFFF, 1.f, 1.f },
		{ 0.f, 350.f, 1.f, 1.0f, 0xFFFFFFFF, 0.0f, 1.f }
	};
	CUSTOMVERTEX TitleText[4]
	{
		{ 0.f, 0.f, 1.f, 1.0f, 0xFFFFFFFF, 0.0f, 0.0f },
		{ 1280.f, 0.f, 1.f, 1.0f, 0xFFFFFFFF, 1.0f, 0.0f },
		{ 1280.f, 350.f, 1.f, 1.0f, 0xFFFFFFFF, 1.0f, 1.0f },
		{ 0.f, 350.f, 1.f, 1.0f, 0xFFFFFFFF, 0.0f, 1.0f }
	};
	...
	case TitleScene:
		...
		//SetGameScene(g_pGameTexture[BACKGROUND_TEX], TitleText);
